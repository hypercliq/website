...
function Dots({ totalSlides = 0 }) {
  ...
  return (
    <div className="relative bottom-8 flex justify-center">
      <div
        ref={stretchDotRef}
        className="absolute bottom-0 m-1 h-2 w-2 rounded-full bg-accent dark:bg-darkAccent"
          ...
          <Dot
            ...
            className={`${
              index === currentDot
                ...
                : 'bg-accent/30 dark:bg-darkAccent/30'
...
const SolutionsCarousel = ({
  ...
  return (
    ...
    >
      ...
      <ButtonBack>
        <ChevronLeftIcon className="absolute bottom-1/2 left-0 h-12 w-12 text-accent dark:text-darkAccent" />
      </ButtonBack>
      <ButtonNext>
        <ChevronRightIcon className="absolute bottom-1/2 right-0 h-12 w-12 text-accent dark:text-darkAccent" />
      </ButtonNext>
