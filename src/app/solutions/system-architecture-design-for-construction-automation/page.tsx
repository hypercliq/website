...
import MainContainer from '@/app/components/Container'
  ...
  return (
    <MainContainer>
      ...
      <section className="mt-8">
        <p>
          Our system architecture design for construction automation represents
          a groundbreaking solution that integrates cutting-edge technologies
          for worker safety, support, and the creation of Dynamic Semantic
          Digital Twins (DSDTs) of construction sites. By combining wearables,
          vision-empowered robots, scanning devices, and AI-based software, we
          usher in a new era of digital construction, ensuring efficiency,
        ...
        <div className="md:order-2 md:w-3/5">
          ...
          <section>
            <p>
              ...
              vision-empowered robots, scanning devices, and AI-based software.
              This integration enables the creation of Dynamic Semantic Digital
              Twins (DSDTs) of construction sites, providing a comprehensive and
              real-time understanding of project dynamics.
            </p>
          </section>
          ...
          <section className="mt-8">
            <p>
              Notably, our system architecture is meticulously aligned with the
              EU’s Data strategy, ensuring compliance with the highest standards
              in security, privacy, and data integrity. This commitment to data
              governance safeguards sensitive information and fosters trust in
              the application of advanced technologies in the construction
              industry.
            </p>
          </section>
          ...
          <section className="mt-8">
            <p>
              ...
              initiative aims to advance the European construction industry. The
              project focuses on increasing the safety and well-being of the
              workforce, improving productivity, and making the industry greener
          ...
          <section className="mt-8">
            <p>
              ...
              facilitate the inventory of materials used in buildings, promoting
              reuse and recycling. This approach advances circularity,
              significantly reducing resource waste and greenhouse gas emissions
          ...
          <section className="mt-8">
            <p>
              ...
              successfully enhanced safety, productivity, and sustainability in
              construction projects. The creation of Dynamic Semantic Digital
              Twins (DSDTs) has provided stakeholders with invaluable insights,
              ensuring informed decision-making and efficient project
              management.
            </p>
          </section>
        </div>
