    ...
    <MainContainer>
      ...
      <section className="mt-8">
        <p>
          ...
          Management Platform stands as a beacon of innovation. This cloud-based
          platform is meticulously designed to streamline the development of
          sustainable products by seamlessly gathering and providing access to a
          wealth of knowledge. From new product samples and materials to
          engineering properties, manufacturing processes, and their
          correlations with desired product characteristics — including vital
          Sustainability Parameters such as environmental footprint and
          recyclability — this platform sets a new standard for environmentally
          conscious design.
        </p>
      </section>
        ...
        <div className="md:order-2 md:w-3/5">
          ...
          <section>
            <p>
              ...
              intricacies of creating environmentally conscious and sustainable
              solutions, fostering efficiency and excellence in the pursuit of a
              greener future.
            </p>
          </section>
          ...
          <section className="mt-8">
            <p>
              ...
              Infinity project, led by Adidas and funded by the European Union’s
              Horizon 2020 Framework Programme for Research and Innovation, the
              platform played a crucial role in achieving key project
              objectives:
            </p>
          ...
          <section className="mt-8">
            <p>
              ...
              expectations. By seamlessly integrating sustainability parameters
              into the design process, it has facilitated the creation of
              sporting goods that are not only cutting-edge in design but also
              environmentally responsible.
            </p>
            <p>
              Overcoming challenges in material selection, production processes,
              and design integration, the platform has become an instrumental
              tool for Adidas and its partners in the pursuit of sustainable
              innovation. The result is a revolution in the sports industry,
              where every gram of a football boot can be broken down and
              recycled into a 3D shapeable material for the next creator to mold
              into their dream product without the use of adhesives.
            </p>
          </section>
        </div>
