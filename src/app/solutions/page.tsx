...
const ProjectSection: React.FC<ProjectSectionProps> = ({
  ...
  <section className="mt-16">
    ...
    >
      <div className="mb-4 max-h-72 w-full overflow-hidden shadow-md md:mb-0 md:h-auto md:w-1/2">
        <Image
          src={imageSrc}
          alt={title}
          // layout="responsive"
  ...
  return (
    <MainContainer>
      <div className="text-center">
        ...
        <p className="text-lg">
          Explore our showcase of past projects and case studies to witness the
          transformative power of our data-driven solutions. Each story reflects
          our commitment to innovation and the tangible impact we bring to
