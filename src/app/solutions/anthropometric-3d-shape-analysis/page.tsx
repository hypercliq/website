    ...
    <MainContainer>
      ...
      <section className="mt-8">
        <p>
          ...
          engineers to seamlessly capture and visualize intricate shape data for
          the entire human body or specific body parts in real time. This
        ...
        <div className="md:order-2 md:w-3/5">
          ...
          <section className="mt-8">
            <p>
              ...
              visualization of 3D human body surface data, seamless integration
              into product development processes, utilization of existing data
              resources by database owners, and the opportunity for third-party
              IT companies to develop innovative services tapping into pooled
              data.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p>
              ...
              algorithms, ensuring the accurate capture and visualization of 3D
              shape data. The tools seamlessly integrate into existing
          ...
          <section className="mt-8">
            <p>
              ...
              Working in tandem with EUROFIT project partners, our team fostered
              an environment of innovation, drawing on diverse expertise to
              create tools that address the evolving needs of industries relying
          ...
          <section className="mt-8">
            ...
            <p>
              While faced with the challenge of transforming vast datasets into
              actionable insights, our team navigated this by implementing
              advanced algorithms and user-friendly interfaces. The result is a
              set of tools that empower industries to extract maximum value from
              anthropometric data.
            </p>
          </section>
          ...
          <section className="mt-8">
            <p>
              ...
              human body shapes, setting new standards for product development.
            </p>
          </section>
        </div>
      ...
      <section className="mt-8">
        <p className="text-center text-lg md:text-left">
          Ready to revolutionize your product development process? Contact us to
          explore how Anthropometric 3D Shape Analysis can elevate your design
