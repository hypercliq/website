    ...
    <MainContainer>
      ...
      <section className="mt-8">
        <p>
          ...
          serve as a visual repository within a pioneering R&D initiative in the
          field of Agriculture. Tailored for the storage and processing of
          ...
          pipeline—from agricultural fields to the creation of datasets for Deep
          Learning.
        </p>
      </section>
      ...
      <section className="mt-8">
        <p className="text-center text-lg md:text-left">
          ...
          explore how our Visual Repository for Agricultural R&D Innovation can
          enhance your capabilities in visual data management and accelerate
          innovation.
        </p>
      </section>
