    ...
    <MainContainer>
        ...
        <div className="md:order-2 md:w-3/5">
          ...
          <section>
            <p>
              ...
              recognized standards such as OWAS and relevant ISO norms, ensuring
              a robust and reliable analysis. Leveraging AI-based software, we
              achieve valid and trustworthy movement data, enabling the
              simultaneous ergonomic assessment of 5-10 workers.
            </p>
          </section>
          ...
          <section className="mt-8">
            <p>
              ...
              proactively optimize their environments for improved productivity
          ...
          <section className="mt-8">
            <p>
              ...
              2020 Framework Programme for Research and Innovation. The project
              aimed to develop an unobtrusive, autonomous, and
              ...
              interventions adapted to the needs and fitness levels of specific
              aging workforce.
            </p>
            <p>
          ...
          <section className="mt-8">
            <p>
              ...
              standards and incorporating AI and Machine Learning capabilities,
              we provide businesses with actionable insights to optimize
              workplace conditions. The simultaneous assessment of multiple
              workers, real-time risk alerting, and continuous coaching
      ...
      <section className="mt-8">
        <p className="text-center text-lg md:text-left">
          ...
          assessments? Contact us to explore how our 3D Motion Tracking platform
          can enhance workplace efficiency and promote employee well-being.
        </p>
      </section>
