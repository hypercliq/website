    ...
    <MainContainer>
      ...
      <section className="mt-8">
        <p>
          ...
          concepts and providing comprehensive support for funding applications,
          particularly targeting EU funding for project development. We go
          beyond traditional consulting by actively researching existing
          technologies and their application, propelling the design and
          manufacturing of groundbreaking products.
        </p>
      </section>
        ...
        <div className="md:order-2 md:w-3/5">
          ...
          <section>
            <p>
              ...
              era of consumer goods. Our work has resulted in the formulation of
              multiple projects, the establishment of interdisciplinary
          ...
          <section className="mt-8">
            <p>
              ...
              production of easily customizable sporting goods. The project not
              only allowed for greater design freedom but also paved the way for
              the manufacturing of sustainable sports goods.
            </p>
          </section>
        </div>
