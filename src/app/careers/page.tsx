  ...
  return (
    <MainContainer>
      ...
      <div className="text-center">
        <h1 className="mb-2 text-4xl font-bold text-primary">Join Our Team</h1>
      ...
      <section className="mt-8">
        <p>
          At Hypercliq, we believe in the power of innovation and the value of a
          diverse and dynamic team. Although we may not have specific openings
          at the moment, we&apos;re always on the lookout for talented
          individuals who share our passion for pushing boundaries and creating
      ...
      <section className="mt-8">
        <p className="text-lg">
          ...
          — we&apos;d{' '}
          <HeartIcon className="inline-block h-6 w-6 text-red-500" /> to
          connect.
        </p>
      </section>
    </MainContainer>
