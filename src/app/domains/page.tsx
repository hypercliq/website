      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="flex flex-col items-center justify-center gap-4 md:flex-row md:items-start">
          ...
          <p className="text-lg md:w-1/2">
            ...
            purpose: to <HighlightSpan>transform</HighlightSpan> the modern
            world through <HighlightSpan>data-driven solutions</HighlightSpan>.
          </p>
        </div>
        ...
        <section className="mt-8">
          ...
          <p className="">
            ...
            Learning, and Data Analysis. We don&apos;t just provide solutions;
            we architect the future. Our passion for innovation fuels our
        ...
        <section className="mt-8">
          ...
          <ul className="list-disc space-y-4 pl-6">
            <li>
              ...
              Bringing together a fusion of talent, we specialize in
              transcending traditional domain barriers. Whether you&apos;re in
              healthcare, finance, education, or any other field, our team
              thrives on challenges and excels in finding data-driven solutions.
            </li>
            <li>
              <span className="font-semibold">Collaboration at its Core:</span>{' '}
              We believe in the power of collaboration. You bring your domain
            ...
            <li>
              <span className="font-semibold">Innovation in Every Pixel:</span>{' '}
              In a world that&apos;s constantly evolving, innovation is not just
              a choice; it&apos;s a necessity. We are committed to exploring new
              possibilities, pushing the boundaries of what&apos;s achievable,
              and delivering impactful solutions that transform entire
              industries.
            </li>
          </ul>
        </section>
        ...
        <section className="mt-8">
          ...
          <ol className="list-decimal space-y-4 pl-6">
            <li>
              <span className="font-semibold">Understanding Your Needs:</span>{' '}
              We start by diving deep into your specific challenges, gaining a
            ...
            <li>
              ...
              commitment doesn&apos;t end with the solution. We stay ahead of
              the curve, continuously innovating to keep your strategies aligned
              with the dynamic landscape of data and technology.
            </li>
          </ol>
        </section>
